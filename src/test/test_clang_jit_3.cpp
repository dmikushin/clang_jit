...
public:
  SimpleOptimizer(unsigned optimization_level = 3,
                  bool internalize_symbols_ = false)
    ...
    tm = LLVMCreateTargetMachine(targ, targetTriple.c_str(), targetCPU.c_str(),
                                 "", level, LLVMRelocDefault,
